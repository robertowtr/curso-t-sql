--Dessa forma cria as colunas de ValidFrom e To e mantém essas colunas atualizadas com a última
--data de atualização
...
--Dessa forma vai buscar os registros válidos para essa data
select * from dbo.tblEmployeeTemporal
for system_time as of '2020-11-06 17:59:14.27'

--Dessa forma vai buscar os registros em um período
select * from dbo.tblEmployeeTemporal
for system_time as of '2020-11-06 17:59:14.27'